...
# A média móvel é uma ferramenta matemática que permite remover oscilações de uma sequência numérica. Do ponto de vista de processamento digital de sinais, a média móvel se trata de um filtro digital passa-baixas, ou seja, remove componentes de altas frequências (oscilações) de um sinal digital. O objetivo desta questão é implementar um programa que calcula a média móvel de janela de tamanho 8 de um array de inteiros (32 bits), resultando em um array de saída y (dados filtrados) também de inteiros. O seu programa deve executar as seguintes etapas:
    #       Receber,            do,             usuário,                um,comprimento,N,para,o,array,de,entrada,x.,O,comprimento,N,deve,ser,obrigatoriamente,maior,ou,igual,a,8.,Caso,seja,menor,que,8,deve,apresentar,a,mensagem,“N,inválido”,e,reiniciar,o,programa#,Receber,do,usuário,um,comprimento,N,para,o,array,de,entrada,x.,O,comprimento,N,deve,ser,obrigatoriamente,maior,ou,igual,a,8.,Caso,seja,menor,que,8,deve,apresentar,a,mensagem,“N,inválido”,e,reiniciar,o,programa# Receber do usuário um comprimento N para o array de entrada x. O comprimento N deve ser obrigatoriamente maior ou igual a 8. Caso seja menor que 8, deve apresentar a mensagem “N inválido” e reiniciar o programa;
    #       Alocar,             dinamicamente,  uma,                    região,de,memória,para,o,array,de,entrada,x,de,comprimento,N#,Alocar,dinamicamente,uma,região,de,memória,para,o,array,de,entrada,x,de,comprimento,N# Alocar dinamicamente uma região de memória para o array de entrada x de comprimento N;
    ...
    #       Imprime,            (em,            formato,                de,coluna),o,vetor,de,entrada,x#,Imprime,(em,formato,de,coluna),o,vetor,de,entrada,x# Imprime (em formato de coluna) o vetor de entrada x;
    #       Imprime,            (em,            formato,                de,coluna),o,vetor,de,saída,y#,Imprime,(em,formato,de,coluna),o,vetor,de,saída,y# Imprime (em formato de coluna) o vetor de saída y;
